...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <h2>CCS</h2>
    <ul>
      <li><a href="admin/dashboard.php" class="active text-white"><i class="fas fa-home"></i> Dashboard</a></li>
      <li><a href="admin/addteacher.php" class="text-white"><i class="fas fa-user-shield"></i> Add Admin</a></li>
      ...
      <!-- Logs -->
      <li><a href="admin/logs.php" class="text-white"><i class="fa-solid fa-clock"></i> Logs</a></li>
